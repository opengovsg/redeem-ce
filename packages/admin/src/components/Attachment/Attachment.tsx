...
import { FileUploadingSpinner } from 'components/Spinners'
...
export interface AttachmentProps extends UseFormControlProps<HTMLElement> {
  ...
  /**
   * Progress of the attachment loading/
   */
  progress: number

  /**
   * Is there any upload of files
   */
  isUploading: boolean
}
      ...
      async ([acceptedFile], rejectedFiles) => {
        if (rejectedFiles.length > 0) {
          ...
          switch (firstError.code) {
            ...
            case 'too-many-files': {
              errorMessage =
                'You have selected more than 1 file, please upload only 1 file'
              break
            }
            default:
